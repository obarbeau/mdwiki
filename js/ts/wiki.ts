...
markdown=markdown.replace(/\[(NOK)\](.*)/gi, "<div class=\"$1 fa-thumbs-down\">&nbsp;$2");
markdown=markdown.replace(/\[(now)\](.*)/gi, "<div class=\"$1 fa-arrow-circle-right\">&nbsp;$2");
markdown=markdown.replace(/\[(wrn)\](.*)/gi, "<div class=\"$1 fa-warning\">&nbsp;$2");
